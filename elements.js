...
const hydrogenBody = `<!DOCTYPE html>
<html lang="en">
<head>
  <meta charset="UTF-8">
...
const indexLength = indexBody.length;

const cssBody = `@import url(http://fonts.googleapis.com/css?family=Open+Sans|Roboto+Slab);
